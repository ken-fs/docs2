...
const zhHans: Dictionary = {
  ...
  guideIndex: {
    ...
    description:
      "七篇实操，六篇讲的都是第一次转不顺的那些情况：Word 格式、PDF 版式、Google 文档粘贴、乱糟糟的 HTML、CSV 表格、Excel 公式 —— 以及一篇讲怎么完全不上传文件。",
    h1: "教程",
    lede: [
      "每个转换器都有一页说明它能做什么。这些文章管的是后面那件事 —— 出来的文件不对，以及为什么。",
      "一个引擎配一篇，外加一篇讲怎么让文件不出浏览器、不走网络，题目全来自真的有人问过的问题。每页都直接链到它讲的那个转换器。",
    ],
  },
  guides: {
    "word-to-markdown-without-uploading": {
      ...
      title: "把 Word 转成 Markdown，文件不上传到任何地方",
      description:
        ".docx 是在这个浏览器标签页里解开的，不发给服务器。这篇讲怎么自己确认这一点、为什么纯文本产物才是私密的那部分，以及在浏览器里转仍然保护不了什么。",
      keywords: [
        "word 转 markdown 不上传",
        "离线 word 转 markdown",
        "docx 转 markdown 保密",
        "在线转 word 转 markdown 安全吗",
        "word 转 markdown 不走服务器",
      ],
      h1: "把 Word 变成 Markdown，文件不离开你的电脑",
      lede: [
        "多数在线转换器是拿走你的文件、发到服务器、再把结果递回来。这一个什么都不发 —— .docx 就在这个标签页里打开。",
        "越是你会犹豫要不要上传的文档，这一点越要紧：一份合同、一份还没发的草稿、任何写着客户名字的东西。所以这句话值得你自己去查一遍，而不是听着就信。",
      ],
      tool: "word-to-markdown",
      sections: [
        {
          heading: "文件去了哪儿：哪儿都没去",
          body: [
            ".docx 是一个 zip 压缩包。打开它就是解开它、读里面的 XML，而这每一步都在这个页面上用 JavaScript 跑 —— 就是页面加载时浏览器早就下好的那段代码。",
            "没有上传，是因为压根没有可上传的地方。这个工具就是几个静态文件，背后没有任何东西在等你的文档。字节留在你正坐着的这台机器上。",
          ],
        },
        {
          heading: "自己验一下：把网线拔了",
          steps: [
            "先把这个页面开一次，然后关掉 wifi 或者拔掉网线。",
            "丢一个 .docx 进去。它照样转，跟刚才一模一样 —— 离线，也没地方可发。",
            "想要证据而不是演示？打开开发者工具，盯着 Network 面板，转一个文件。没有任何东西带着它出去。",
          ],
          body: [
            "一次离线转换就是整个论点的一个动作版本：会往外打电话的代码，在电话线拔了之后没法工作。",
          ],
        },
        {
          heading: "纯文本产物才是私密的那部分",
          body: [
            "Markdown 是纯文本。产物的每一个字符都在你眼前的屏幕上，粘到任何地方之前你都能通读一遍 —— 没有留下一层看不见的东西要你去信。",
            ".docx 正相反。它带着作者名、编辑历史、修订痕迹和模板路径，藏在你从来看不到的地方。转成 Markdown 就把这些留在了身后：文字过来了，埋着的元数据没有，因为纯文本没有地方存它。",
          ],
        },
        {
          heading: "一个普通在线转换器会怎么做",
          body: [
            "它上传。你的文件落在别人电脑上的临时存储里，在那边转好，事后本应被删掉 —— 按一个你看不到、也查不了的时间表。",
            "转个梗图，无所谓。可要是签了保密协议的东西，「一小时内删除」是一句承诺，而一句承诺跟一个从没被发出去的文件，是两回事。",
          ],
        },
        {
          heading: "在浏览器里转做不到什么",
          body: [
            "把边界说清楚也是应该的。让文件不走网络，跟你拿结果去干什么没有关系：把 Markdown 贴进一个公开的 gist，它就是公开的，不管它是怎么到那儿的。",
            "任何已经在盯着你这台机器的东西照样看得见 —— 一个有权限读这个页面的浏览器扩展，或者恶意软件，你读到什么它就读到什么。本地转换去掉的是上传这一步，不是每一种风险。它去掉的是最大的那个：一份你的文档副本，躺在陌生人的服务器上。",
          ],
        },
      ],
      outro:
        "想踏实就先把网断了，再把 .docx 丢进来。它在这个标签页里解开，不会再往前走一步。",
    },
